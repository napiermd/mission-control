        ...
        <div className="min-h-screen flex flex-col">
          <header className="border-b border-space-border px-6 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-hud-muted text-xs" suppressHydrationWarning>{new Date(Date.now() + (-7 * 60 * 60 * 1000)).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric', timeZone: 'UTC' })}</span>
